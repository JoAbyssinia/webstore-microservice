...
public class ProductUtil {
    ...
    public Product parseProductRequestDTOToProduct(ProductRequestDTO productRequestDto) {
        return new Product(null, productRequestDto.getProductNumber(),
                productRequestDto.getName(), productRequestDto.getPrice(),
                productRequestDto.getDescription());
    }

    public ProductResponseDTO parseProductTOProductResponseDTO(Product product) {
        return ProductResponseDTO.builder().productNumber(product.getProductNumber())
